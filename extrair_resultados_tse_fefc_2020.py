...
Esta versão está configurada especificamente para as eleições municipais de 2020.
...
def analisar_argumentos(argv: Iterable[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        required=True,
        type=Path,
        help="Caminho do CSV de FEFC, por exemplo fefc_cor_raca_2020.csv.",
    )
    parser.add_argument(
        "--ano",
        type=int,
        default=2020,
        choices=[2020],
        help="Ano eleitoral fixado em 2020.",
    )
    parser.add_argument(
        "--tse-zip",
        type=Path,
